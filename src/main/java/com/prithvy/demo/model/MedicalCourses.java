...
public class MedicalCourses {
    ...
    public MedicalCourses(Long collegeTypeId, String course) {
        super();
    ...
    public String toString() {
        return "MedicalCourses [id=" + id + ", CollegeTypeId=" + CollegeTypeId + ", course=" + course + "]";
    }
